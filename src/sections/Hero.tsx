...
export const Hero = () => {
  ...
  return (
    ...
    >
      {/* Background overlay */}
      <div className="absolute inset-0 justify-center bg-[radial-gradient(75%_75%_at_center,rgb(140,69,255,.5)_15%,rgb(14,0,36,.5)_78%,transparent)]"></div>

      {/* Central purple glow circle */}
      ...
      <motion.div
        ...
        className="absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] rounded-full border border-white/20 opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      >
      ...
      {/* Outer static rings */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] rounded-full border border-white/20 opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
